  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[3fr_2fr]">
        ...
        {/* Stock status */}
        <div className="rounded-xl border bg-white p-5 shadow-sm">
          <h3 className="mb-4 text-sm font-semibold text-gray-900">Stock Status</h3>
              ...
              return (
                <li key={s.item.id}>
                  <div className="mb-1 flex items-center justify-between text-sm">
                    <span className="text-gray-700">{s.item.name}</span>
      ...
      {/* Row 4 — Report CTA */}
      {latest ? (
        <div className="flex items-center justify-between rounded-xl bg-green-50 px-5 py-4 text-sm text-green-800">
          <span>
        ...
        <div className="flex flex-col items-start justify-between gap-3 rounded-xl bg-amber-50 px-5 py-4 sm:flex-row sm:items-center">
